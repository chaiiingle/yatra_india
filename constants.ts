...
export const SPOTS_DB: TouristSpot[] = [
  // ================= JUNNAR =================
  {
    ...
    categories: [SpotCategory.FORT, SpotCategory.HISTORIC, SpotCategory.TREK, SpotCategory.ADVENTURE],
    durationHours: 3.0,
  ...
  },
  {
    ...
    name: 'Naneghat',
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.TREK, SpotCategory.HISTORIC, SpotCategory.SCENIC_POINT, SpotCategory.ADVENTURE],
    durationHours: 3.0,
  ...
  },
  {
    ...
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.ICONIC, SpotCategory.SELFIE_POINT],
    durationHours: 0.5,
  ...
  },
  {
    ...
    name: 'Shiv Shrusti',
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.CULTURE, SpotCategory.HISTORIC, SpotCategory.MUSEUM],
    durationHours: 1.5,
  ...
  },
  {
    ...
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.SELFIE_POINT, SpotCategory.HISTORIC, SpotCategory.ICONIC],
    durationHours: 1.0,
    description: 'A designated spot offering the perfect backdrop of Shivneri Fort for history and some photos.',
  ...
  },
  {
    ...
    name: 'Harin Tekdi',
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.SCENIC_POINT, SpotCategory.NATURE],
    durationHours: 1.0,
  ...
  },
  {
    ...
    name: 'Jivdhan Fort',
    destination: DestinationName.JUNNAR,
    categories: [SpotCategory.TREK, SpotCategory.FORT, SpotCategory.ADVENTURE, SpotCategory.ICONIC],
    durationHours: 4.0,
  ...
  },
  {
    ...
    destination: DestinationName.MAHABALESHWAR,
    categories: [SpotCategory.ICONIC, SpotCategory.SHOPPING, SpotCategory.NATURE],
    durationHours: 1.0,
  ...
  },
  {
    ...
    destination: DestinationName.MAHABALESHWAR,
    categories: [SpotCategory.SCENIC_POINT, SpotCategory.SELFIE_POINT],
    durationHours: 1.0,
  ...
  },
  {
    ...
    name: 'Rutba Villa',
    destination: DestinationName.MAHABALESHWAR,
    categories: [SpotCategory.SCENIC_POINT, SpotCategory.OTHER],
    durationHours: 0.5,
  ...
  },
  {
    ...
    name: 'Arthur\'s Seat',
    destination: DestinationName.MAHABALESHWAR,
    categories: [SpotCategory.SCENIC_POINT, SpotCategory.NATURE, SpotCategory.SELFIE.POINT],
    durationHours: 2.0,
  ...
  },
  {
    ...
    imageUrl: 'https://mahabaleshwartourism.in/images/tourist-places/lingmala-waterfall-mahabaleshwar/lingmala-waterfall-mahabaleshwar-tourism-location-address.jpg',
  ...
  },
  {
    ...
    destination: DestinationName.OOTY,
    categories: [SpotCategory.BOATING, SpotCategory.ICONIC],
    durationHours: 2.0,
  ...
  },
  {
    ...
    destination: DestinationName.OOTY,
    categories: [SpotCategory.NATURE, SpotCategory.ICONIC],
    durationHours: 2.0,
  ...
  },
  {
    ...
    destination: DestinationName.OOTY,
    categories: [SpotCategory.TREK, SpotCategory.SCENIC_POINT, SpotCategory.ADVENTURE],
    durationHours: 2.0,
  ...
  },
  {
    ...
    destination: DestinationName.OOTY,
    categories: [SpotCategory.LAKE, SpotCategory.WATERFALL, SpotCategory.NATURE],
    durationHours: 2.5,
